...
function ColdCoffee() {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/api/products?category=Cold Coffee")
      .then((res) => res.json())
      .then((data) => setProducts(data))
      .catch((err) => console.log("Error fetching Cold Coffee:", err));
  }, []);
        ...
        {products.length === 0 ? (
          ...
          products.map((item) => (
            ...
            >
              ...
              <div className="h-87 bg-gradient-to-br from-[#4e342e]/40 via-[#6f4e37]/30 to-[#d4a373]/40
